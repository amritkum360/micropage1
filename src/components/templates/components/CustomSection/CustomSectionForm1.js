...
export default function CustomSectionForm1({ section, onInputChange, sectionKey, isOpen }) {
  ...
  return (
    <div className="space-y-3">
      {/* Template 1 Specific Settings */}
      <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
        <h3 className="text-sm font-semibold text-blue-800 mb-2">Template 1: Image Left, Content Right</h3>
        <p className="text-xs text-blue-600">Perfect for showcasing your content with a side-by-side layout. Great for feature highlights and service descriptions.</p>
      </div>
